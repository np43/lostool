...
QT_MOC_LITERAL(1, 4, 10), // "teardownGL"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 6) // "update"

    },
    "Gui\0teardownGL\0\0update"
};
...
const QMetaObject Gui::staticMetaObject = {
    { &QOpenGLWindow::staticMetaObject, qt_meta_stringdata_Gui.data,
...
void *Gui::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< Gui*>(this));
